...
local lbl1 = ui.new_label("RAGE", "Other", "----------------------\aBBC0F3FF Asaka DLC \aE8E8E8FF----------------------")
local resolver_master = ui.new_checkbox("RAGE", "Other", "Evade Asaka Resolver", true)
local resolver_debug = ui.new_checkbox("RAGE", "Other", "Show Devlog")
