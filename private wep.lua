...
local function run_visuals()
    ...
    local function gradient_indicator(r1, g1, b1, a1, r2, g2, b2, a2, text)
        local output = ''
        local temp = 0
        local len = #text-1
        ...
        renderer.indicator( r1, g1, b1, a1,output)
        
    end
        --gradient_indicator(255, 255, 255, 255, 255, 255, 255, 255,"")
    -- if ui_dmg3 then
    ...
    if ui.get(override_hitchance_key) then
		renderer.indicator(202,202,202,255,"HITCHANCE OVR")
	end
end
