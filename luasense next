...
local aa = {}
local function getbuild() return "next" end
...
-- Remove or comment out: local user = "Lopgy"
-- ... (other code) ...
if first_notification_time and not second_notification_triggered then
    if globals.realtime() >= first_notification_time + 2 then 
        ...
        local white = "\aFFFFFFFF"
        notify.new_bottom(179, 255, 18, { { white .. "Welcome back User" .. colored_user .. "  ", true } })
...
return (function(tbl)
    ...
    local category = ui.new_combobox("aa", "anti-aimbot angles", prefix("category" .. rgba(69,169,155,255," " .. (getbuild() == "next" and " (next)" or ""))), {"rage", "anti aimbot", "visuals & misc", "config"})
    ...
    menu = {
        ...
        ["anti aimbot"] = {
            ...
            ["keybinds"] = {
                ...
                reset = ui.new_hotkey("aa", "anti-aimbot angles", prefix("reset")),
            ...
            ["features"] = {
                ...
                safehead = ui.new_multiselect("aa", "anti-aimbot angles", prefix("Safe Head"), {"Knife", "Zeus"}),
        ...
        ["visuals & misc"] = {
            ...
            ["visuals"] = {
                ...
                wtext = ui.new_combobox("aa", "anti-aimbot angles", prefix("wutermark"), {" luasense ", "luasense next", "luasync.max2", "luasync.max", " luasense", "luasense ", "luasense", "w3LLy$eN$E", "custom"}),
        ...
        ["config"] = {
            config_selector = ui.new_combobox("aa", "anti-aimbot angles", prefix("select config"), {"aggressive delayed jitter", "safe delayed jitter", "aggressive jitter", "safe jitter", "perfect jitter", "perfect delay jitter","Lopgy delay jitter","kitty dealy jitter"}),
            load = ui.new_button("aa", "anti-aimbot angles", "\ac8c8c8FF load", function()
                ...
                local check, message = pcall(function()
                    ...
                    elseif selected_config == "Lopgy delay jitter" then
                        tbl = json.parse([[{"LUASENSE":{"duck moving":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-22,"left":36,"fake":60,"yaw":0,"defensive":"off","mode":["yaw","left right"],"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-22,"left":36,"fake":60,"yaw":0,"defensive":"off","mode":["yaw","left right"],"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"extra":{"builder":{"builder":"global","team":"t"},"submenu":"features","features":{"backstab":"forward","legit":"luasense","roll":0,"fix":{},"defensive":"off","distance":250,"fixer":"default","states":{}},"keybinds":{"type_freestand":"jitter","type_manual":"static","keys":["manual","freestand"],"disablers":["air","slow","duck","edge","manual","fake lag"]}},"slow motion":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-29,"left":52,"fake":60,"yaw":0,"defensive":"off","mode":["yaw","left right"],"luasense":3},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-29,"left":52,"fake":60,"yaw":0,"defensive":"off","mode":["yaw","left right"],"luasense":3},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"air duck":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-32,"left":48,"fake":60,"yaw":0,"defensive":"off","mode":["yaw","left right"],"luasense":2},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-32,"left":48,"fake":60,"yaw":0,"defensive":"off","mode":["yaw","left right"],"luasense":2},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"fake lag":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"disabled","luasense":{"right":0,"left":0,"fake":60,"yaw":0,"defensive":"off","mode":{},"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"disabled","luasense":{"right":0,"left":0,"fake":60,"yaw":0,"defensive":"off","mode":{},"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"air":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-23,"left":35,"fake":60,"yaw":0,"defensive":"off","mode":["yaw","left right"],"luasense":2},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-23,"left":35,"fake":60,"yaw":0,"defensive":"off","mode":["yaw","left right"],"luasense":2},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"global":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"normal","luasense":{"right":0,"left":0,"fake":60,"yaw":0,"defensive":"off","mode":{},"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"normal","luasense":{"right":0,"left":0,"fake":60,"yaw":0,"defensive":"off","mode":{},"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"duck":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":["yaw","left right"],"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-27,"left":47,"fake":60,"yaw":0,"defensive":"off","mode":["yaw","left right"],"luasense":2},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":["yaw","left right"],"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-27,"left":47,"fake":60,"yaw":0,"defensive":"off","mode":["yaw","left right"],"luasense":2},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"hide shot":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"disabled","luasense":{"right":0,"left":0,"fake":60,"yaw":0,"defensive":"off","mode":{},"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"disabled","luasense":{"right":0,"left":0,"fake":60,"yaw":0,"defensive":"off","mode":{},"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"moving":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-32,"left":40,"fake":60,"yaw":0,"defensive":"off","mode":["yaw","left right"],"luasense":2},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-32,"left":40,"fake":60,"yaw":0,"defensive":"off","mode":["yaw","left right"],"luasense":2},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"standing":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-32,"left":47,"fake":60,"yaw":0,"defensive":"off","mode":["yaw","left right"],"luasense":3},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-32,"left":47,"fake":60,"yaw":0,"defensive":"off","mode":["yaw","left right"],"luasense":3},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}}}}]])
                    elseif selected_config == "kitty dealy jitter" then
                        tbl = json.parse([[{"LUASENSE":{"duck moving":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-37,"left":37,"fake":60,"yaw":0,"defensive":"luasense","mode":["left right"],"luasense":5},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-37,"left":37,"fake":60,"yaw":0,"defensive":"luasense","mode":["left right"],"luasense":5},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"extra":{"builder":{"builder":"standing","team":"t"},"submenu":"builder","features":{"backstab":"forward","legit":"off","roll":0,"fix":{},"defensive":"off","distance":250,"fixer":"default","states":{}},"keybinds":{"type_freestand":"static","type_manual":"static","keys":["manual","freestand"],"disablers":["air","slow","duck","edge","manual","fake lag"]}},"slow motion":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"disabled","luasense":{"right":0,"left":0,"fake":60,"yaw":0,"defensive":"off","mode":{},"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"disabled","luasense":{"right":0,"left":0,"fake":60,"yaw":0,"defensive":"off","mode":{},"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"air duck":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-36,"left":38,"fake":60,"yaw":0,"defensive":"luasense","mode":["left right"],"luasense":3},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-36,"left":38,"fake":60,"yaw":0,"defensive":"luasense","mode":["left right"],"luasense":3},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"fake lag":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"disabled","luasense":{"right":0,"left":0,"fake":60,"yaw":0,"defensive":"off","mode":{},"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"disabled","luasense":{"right":0,"left":0,"fake":60,"yaw":0,"defensive":"off","mode":{},"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"air":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"jitter","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":0,"left":0,"fake":60,"yaw":0,"defensive":"off","mode":["yaw"],"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"jitter","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"normal","luasense":{"right":0,"left":0,"fake":60,"yaw":0,"defensive":"off","mode":{},"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"global":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-33,"left":31,"fake":60,"yaw":0,"defensive":"luasense","mode":["left right"],"luasense":7},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-33,"left":31,"fake":60,"yaw":0,"defensive":"luasense","mode":["left right"],"luasense":7},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"duck":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-37,"left":37,"fake":60,"yaw":0,"defensive":"luasense","mode":["left right"],"luasense":5},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-37,"left":37,"fake":60,"yaw":0,"defensive":"luasense","mode":["left right"],"luasense":5},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"hide shot":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"disabled","luasense":{"right":0,"left":0,"fake":60,"yaw":0,"defensive":"off","mode":{},"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"disabled","luasense":{"right":0,"left":0,"fake":60,"yaw":0,"defensive":"off","mode":{},"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"moving":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-24,"left":38,"fake":60,"yaw":0,"defensive":"luasense","mode":["left right"],"luasense":5},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"luasense","luasense":{"right":-24,"left":38,"fake":60,"yaw":0,"defensive":"luasense","mode":["left right"],"luasense":5},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}},"standing":{"t":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"normal","luasense":{"right":0,"left":0,"fake":60,"yaw":0,"defensive":"off","mode":{},"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}},"ct":{"normal":{"right":0,"jitter_slider":0,"yaw":0,"method":"default","left":0,"jitter":"off","custom_slider":60,"body":"off","defensive":"off","mode":{},"body_slider":0},"advanced":{"right":0,"left":0,"trigger":"a: brandon","defensive":"off"},"type":"normal","luasense":{"right":0,"left":0,"fake":60,"yaw":0,"defensive":"off","mode":{},"luasense":1},"disabled":{},"auto":{"right":0,"method":"simple","left":0,"defensive":"off","timer":150,"antibf":"no"}}}}}]])
                    end
    ...
    for i, v in next, tbl.states do
        ...
        for index, value in next, {"ct", "t"} do
            aa[v][value] = {
                ["type"] = ui.new_combobox("aa", "anti-aimbot angles", prefix(v .. " " .. value, "type"), (v == "global" and {"normal", "luasense", "advanced", "auto","nextgen"} or {"disabled", "normal", "luasense", "advanced", "auto","nextgen"})),
                ["normal"] = {
                ...
                ["nextgen"] = {
                    ...
                    tick = ui.new_slider("aa", "anti-aimbot angles", prefix(v .. " " .. value, "tick\n"), 1, 10, 1),
                    tick_random = ui.new_slider("aa", "anti-aimbot angles", prefix(v .. " " .. value, "tick random"), 0, 5, 0),
                    jitter = ui.new_slider("aa", "anti-aimbot angles", prefix(v .. " " .. value, "jitter\n"), -180, 180, 0),
                    fake = ui.new_slider("aa", "anti-aimbot angles", prefix(v .. " " .. value, "fake"), 0,60,0),
    ...
    tbl.callbacks = {
        ...
        ["command"] = function(arg)
            ...
            local safehead = ui.get(menu["anti aimbot"]["features"]["safehead"])

            local lp_weapon_safe = entity.get_player_weapon(myself)


            if (lp_weapon_safe ~= nil) and (tbl.contains(safehead,"Zeus") and air and duck and entity.get_classname(lp_weapon_safe) == "CWeaponTaser") or (tbl.contains(safehead,"Knife") and air and duck and entity.get_classname(lp_weapon_safe) == "CKnife") then
            ...
            ui.set(tbl.items.yaw[2],14)
            ui.set(tbl.items.jitter[1],"off")
            ui.set(tbl.items.body[1],"Static")
            ui.set(tbl.items.body[2],1)

            elseif ui.get(menutbl["type"]) == "nextgen" then
                local nextgen_add = 0
                menutbl = menutbl[ui.get(menutbl["type"])]
                if arg.chokedcommands == 0 then
                    nextgen_.choke = nextgen_.choke + 1
                end
                if (nextgen_.choke - nextgen_.last_packets >= nextgen_.delay) then
                    nextgen_.delay = (ui.get(menutbl["tick_random"]) == 0 and ui.get(menutbl["tick"]) or client.random_int(ui.get(menutbl["tick"]),1+ui.get(menutbl["tick_random"])))
                    nextgen_.switch = not nextgen_.switch
                    nextgen_.last_packets = nextgen_.choke
                end
                nextgen_add = nextgen_add + (nextgen_.switch and ui.get(menutbl["left"]) or ui.get(menutbl["right"]))
                nextgen_add = nextgen_add + (nextgen_.switch and -ui.get(menutbl["jitter"])/2 or ui.get(menutbl["jitter"])/2)
                ui.set(tbl.items.yaw[2],nextgen_add)
                ui.set(tbl.items.jitter[1],"off")
                ui.set(tbl.items.body[1],"Static")
                ui.set(tbl.items.body[2],(nextgen_.switch and -ui.get(menutbl["fake"]) or ui.get(menutbl["fake"])))
            ...
            elseif ui.get(menutbl["type"]) == "normal" then
                menutbl = menutbl[ui.get(menutbl["type"])]
        ...
        ["menu"] = function()
            ...
            ui.set(menu["anti aimbot"]["keybinds"]["reset"], "on hotkey")
            ...
            if ui.get(menu["anti aimbot"]["keybinds"]["reset"]) and (tbl.antiaim.manual.tick < tick - 11) then
                tbl.antiaim.manual.aa = 0
                tbl.antiaim.manual.tick = tick
            end
    ...
    for index, value in next, v do
        if i == "anti aimbot" and index ~= "submenu" then
            for ii, vv in next, value do
                ...
                if index == "keybinds" then
                    ...
                    if ii == "left" or ii == "right" or ii == "forward" or ii == "backward" or ii == "reset" or ii == "type_manual" then
        ...
        ["arrows"] = function()
            ...
            if myself ~= nil and entity.is_alive(myself) then
                ...
                elseif text_to_draw == "luasense next" then
                    local lua_text = "L u a"
                    local sense_text = "S e n s e"
                    local beta_text = "[Next]"
